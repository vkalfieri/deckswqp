...
class TradesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create trade" do
    assert_difference('Trade.count') do
      post trades_url, params: { trade: { buyer_id: @trade.buyer_id, trade_id: @trade.trade_id, trade_type: @trade.trade_type } }
    end
  ...
  test "should update trade" do
    patch trade_url(@trade), params: { trade: { buyer_id: @trade.buyer_id, trade_id: @trade.trade_id, trade_type: @trade.trade_type } }
